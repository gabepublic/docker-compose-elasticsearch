...
if __name__ == "__main__":
    ...
    parser.add_argument('--commandline', help='running in command line mode', 
                          type=bool, default=False)
    args = parser.parse_args()
    # Use the following when running outside the container and connecting to
    # ElasticSearch container via localhost port
    if args.commandline is True:
        print("running in commandline mode, outside docker container...")
        es = Elasticsearch()
